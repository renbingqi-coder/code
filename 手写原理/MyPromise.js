...
const MyPromise = (() => {
    const PENDING = "pending",
        ...
        thenables = Symbol("thenables"), //thenables   队列
        catchables = Symbol("catchbles"), //catchables   队列
        changeStatus = Symbol("changeStatus"), //改变状态函数
...
new Promise(resolve => {
    ...
    .then(() => {
        new Promise(resolve => {
            ...
            .then(() => {
                console.log(1);
                Promise.resolve().then().then().then(() => console.log(4))
                    .then(() => console.log("5"))
                    .then(() => console.log("6"))
            })
        // .then(() => console.log(4))
